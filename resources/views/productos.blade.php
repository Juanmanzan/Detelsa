    ...
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-start">
            @foreach ($productos as $producto)
                <div class="col mb-5">
                    <div class="card h-100" onclick="window.location='{{ route('productoinfo', $producto->id) }}'" style="cursor: pointer;">
                        ...
                        <div class="d-flex flex-row justify-content-center">
                            ...
                            <a class="btn btn-outline-success d-flex align-items-center justify-content-center ms-4 mb-5 btn-agregar-carrito" 
                                href="#"  onclick="agregarAlCarrito({{ $producto->id }}); event.stopPropagation(); return false;">
